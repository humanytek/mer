...
{
    'name': 'Reporte de personel',
    'version': '1.1',
    'category': 'MRP',
    'summary': 'Reporte de personel',
    'description': """
Manage Customer Claims.
=======================
This application allows you to track your manufacturing order details. 
A graphical and list view of reporting..
    ...
    'data': [
             'stock_view.xml',
        'report/reporte_de_personal_view.xml',
